import{d as p}from"./index-DfD72SYS.js";let C={data:""},D=t=>{if(typeof window=="object"){let e=(t?t.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return e.nonce=window.__nonce__,e.parentNode||(t||document.head).appendChild(e),e.firstChild}return t||C},L=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,S=/\/\*[^]*?\*\/|  +/g,A=/\n+/g,g=(t,e)=>{let a="",o="",s="";for(let i in t){let r=t[i];i[0]=="@"?i[1]=="i"?a=i+" "+r+";":o+=i[1]=="f"?g(r,i):i+"{"+g(r,i[1]=="k"?"":e)+"}":typeof r=="object"?o+=g(r,e?e.replace(/([^,])+/g,n=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,l=>/&/.test(l)?l.replace(/&/g,n):n?n+" "+l:l)):i):r!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),s+=g.p?g.p(i,r):i+":"+r+";")}return a+(e&&s?e+"{"+s+"}":s)+o},u={},z=t=>{if(typeof t=="object"){let e="";for(let a in t)e+=a+z(t[a]);return e}return t},P=(t,e,a,o,s)=>{let i=z(t),r=u[i]||(u[i]=(l=>{let c=0,m=11;for(;c<l.length;)m=101*m+l.charCodeAt(c++)>>>0;return"go"+m})(i));if(!u[r]){let l=i!==t?t:(c=>{let m,b,h=[{}];for(;m=L.exec(c.replace(S,""));)m[4]?h.shift():m[3]?(b=m[3].replace(A," ").trim(),h.unshift(h[0][b]=h[0][b]||{})):h[0][m[1]]=m[2].replace(A," ").trim();return h[0]})(t);u[r]=g(s?{["@keyframes "+r]:l}:l,a?"":"."+r)}let n=a&&u.g?u.g:null;return a&&(u.g=u[r]),((l,c,m,b)=>{b?c.data=c.data.replace(b,l):c.data.indexOf(l)===-1&&(c.data=m?l+c.data:c.data+l)})(u[r],e,o,n),r},T=(t,e,a)=>t.reduce((o,s,i)=>{let r=e[i];if(r&&r.call){let n=r(a),l=n&&n.props&&n.props.className||/^go/.test(n)&&n;r=l?"."+l:n&&typeof n=="object"?n.props?"":g(n,""):n===!1?"":n}return o+s+(r??"")},"");function w(t){let e=this||{},a=t.call?t(e.p):t;return P(a.unshift?a.raw?T(a,[].slice.call(arguments,1),e.p):a.reduce((o,s)=>Object.assign(o,s&&s.call?s(e.p):s),{}):a,D(e.target),e.g,e.o,e.k)}let O,$,E;w.bind({g:1});let f=w.bind({k:1});function H(t,e,a,o){g.p=e,O=t,$=a,E=o}function y(t,e){let a=this||{};return function(){let o=arguments;function s(i,r){let n=Object.assign({},i),l=n.className||s.className;a.p=Object.assign({theme:$&&$()},n),a.o=/ *go\d+/.test(l),n.className=w.apply(a,o)+(l?" "+l:"");let c=t;return t[0]&&(c=n.as||t,delete n.as),E&&c[0]&&E(n),O(c,n)}return s}}var M=t=>typeof t=="function",k=(t,e)=>M(t)?t(e):t,Z=(()=>{let t=0;return()=>(++t).toString()})(),q=(()=>{let t;return()=>{if(t===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");t=!e||e.matches}return t}})(),Q=20,_="default",I=(t,e)=>{let{toastLimit:a}=t.settings;switch(e.type){case 0:return{...t,toasts:[e.toast,...t.toasts].slice(0,a)};case 1:return{...t,toasts:t.toasts.map(r=>r.id===e.toast.id?{...r,...e.toast}:r)};case 2:let{toast:o}=e;return I(t,{type:t.toasts.find(r=>r.id===o.id)?1:0,toast:o});case 3:let{toastId:s}=e;return{...t,toasts:t.toasts.map(r=>r.id===s||s===void 0?{...r,dismissed:!0,visible:!1}:r)};case 4:return e.toastId===void 0?{...t,toasts:[]}:{...t,toasts:t.toasts.filter(r=>r.id!==e.toastId)};case 5:return{...t,pausedAt:e.time};case 6:let i=e.time-(t.pausedAt||0);return{...t,pausedAt:void 0,toasts:t.toasts.map(r=>({...r,pauseDuration:r.pauseDuration+i}))}}},R=[],W={toasts:[],pausedAt:void 0,settings:{toastLimit:Q}},x={},N=(t,e=_)=>{x[e]=I(x[e]||W,t),R.forEach(([a,o])=>{a===e&&o(x[e])})},F=t=>Object.keys(x).forEach(e=>N(t,e)),Y=t=>Object.keys(x).find(e=>x[e].toasts.some(a=>a.id===t)),j=(t=_)=>e=>{N(e,t)},B=(t,e="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:t,pauseDuration:0,...a,id:a?.id||Z()}),v=t=>(e,a)=>{let o=B(e,t,a);return j(o.toasterId||Y(o.id))({type:2,toast:o}),o.id},d=(t,e)=>v("blank")(t,e);d.error=v("error");d.success=v("success");d.loading=v("loading");d.custom=v("custom");d.dismiss=(t,e)=>{let a={type:3,toastId:t};e?j(e)(a):F(a)};d.dismissAll=t=>d.dismiss(void 0,t);d.remove=(t,e)=>{let a={type:4,toastId:t};e?j(e)(a):F(a)};d.removeAll=t=>d.remove(void 0,t);d.promise=(t,e,a)=>{let o=d.loading(e.loading,{...a,...a?.loading});return typeof t=="function"&&(t=t()),t.then(s=>{let i=e.success?k(e.success,s):void 0;return i?d.success(i,{id:o,...a,...a?.success}):d.dismiss(o),s}).catch(s=>{let i=e.error?k(e.error,s):void 0;i?d.error(i,{id:o,...a,...a?.error}):d.dismiss(o)}),t};var G=f`
from {
...
`,ct="0%{opacity:0;} 100%{opacity:1;}",pt="0%{opacity:1;} 100%{opacity:0;}",mt=y("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
